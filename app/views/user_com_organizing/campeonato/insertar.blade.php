			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							  {{ Form::open(array('url' => 'campeonato/formulario1','method' => 'post', 'files' => true, 'class' => 'form-horizontal')) }}
							
								<div class="form-group">
									<label>Codigo</label>
									<input class="form-control" placeholder="Codigo del campeonato" name="Codigo">
								</div>
								<div class="form-group">
									<label>Nombre</label>
								...
								<div class="form-group">
									...
									<input class="form-control" placeholder="2015-II" name="Anio">
								</div>
