...
<div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Lista de Inciencias <div style="float:right"><a href="insertar">Agregar</a></div></div> 
                    ...
                    <div class="panel-body">
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" class="table table-bordered">
                            <thead>
                            {{ Form::open(array('url' => 'incidencias/buscarincidencias',
                                'method' => 'GET',
                                'class' =>'form-inline',
                                'role' => 'form')) }}
                            <tr>
                                <th data-field="state" data-checkbox="true" >{{Form::input('text','codincidencias',Input::get('codincidencias'),array('class'=>'form-control')) }}</th>
                                <th data-field="id" data-sortable="true">{{Form::input('text','incidencias',Input::get('incidencias'),array('class'=>'form-control')) }}</th>
                                <th data-field="name"  data-sortable="true">{{Form::input('text','hora',Input::get('hora'),array('class'=>'form-control')) }}</th>
                                <th data-field="price" data-sortable="true">{{Form::input('text','codpartido',Input::get('codpartido'),array('class'=>'form-control')) }}</th>
                            ...
                            <tr>
                                ...
                                <th data-field="id" data-sortable="true" style="text-decoration:underline">Incidencias</th>
                                <th data-field="name"  data-sortable="true" style="text-decoration:underline">Hora</th>
                                <th data-field="price" data-sortable="true" style="text-decoration:underline">Codigo partido</th>
                                <th data-field="price" data-sortable="true" style="text-decoration:underline">Opciones</th>
                            </tr>
                            </thead>
                            <tbody>
                                <!--<tr><td>camp001</td><td>abc</td><td>1234</td><td>5678</td></tr>-->
                                @foreach($todoincidencias as $incidencias)
                        <tr>
                            <td>{{$incidencias->codincidencias}}</td>
                            <td>{{$incidencias->incidencias}}</td>
                            <td>{{$incidencias->hora}}</td>
                            <td>{{$incidencias->codpartido}}</td>
                            <td>
                                <a href="editar/{{ $incidencias->codincidencias}}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
                                 <a href="eliminar/{{ $incidencias->codincidencias}}" class="btn btn-xs btn-secundary" style="background-color:#900 !important"><i class="glyphicon glyphicon-trash" ></i></a>
